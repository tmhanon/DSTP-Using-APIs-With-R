...
## Summarizing What We Learned {.inverse}

::: {.incremental}
- [***Web APIs***]{.hl-darkblue-darkgreen} allow *authorized* users to access data through a structured *request-response* framework. 
...
- [***Build a function once you know how an API works!***]{.hl-darkblue-darkgreen}
:::
...
```{=html}
<div style="position: absolute;top: 60%;margin-left: 1em;">
  ...
  <p style="margin-top: 12px;">
    Slides: 
    <a href="https://tmhanon.github.io/DSTP-Using-APIs-With-R/" target="_blank" rel="noopener">
      <code>tmhanon.github.io/DSTP-Using-APIs-With-R/</code>
    </a>
  </p>
  <p style="margin-top: 12px;">
    Source Code: 
    <a href="https://github.com/tmhanon/DSTP-Using-APIs-With-R" target="_blank" rel="noopener">
      <code>github.com/tmhanon/DSTP-Using-APIs-With-R</code>
    </a>
  </p>
</div>
```
